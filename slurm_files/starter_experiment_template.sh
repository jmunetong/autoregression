#!/bin/bash
#SBATCH --account=mph121                    # TODO: Replace with your account
#SBATCH --partition=batch                   # TODO: Adjust partition as needed
#SBATCH --qos=normal                        # TODO: Adjust QoS as needed
#SBATCH --time=04:00:00                     # TODO: Set appropriate time limit
#SBATCH --nodes=2                           # TODO: Set number of nodes (2-100)
#SBATCH --ntasks-per-node=8                 # TODO: Tasks per node (usually = GPUs per node)
#SBATCH --cpus-per-task=7                   # TODO: CPUs per task
#SBATCH --gpus-per-node=8                   # TODO: GPUs per node
#SBATCH --job-name=my_experiment            # TODO: Give your experiment a descriptive name
#SBATCH --output=slurm/my_experiment-%j.out # TODO: Update output file path
#SBATCH --error=slurm/my_experiment-%j.err  # TODO: Update error file path
#SBATCH --mail-type=END,FAIL                # TODO: Optional - email notifications
#SBATCH --mail-user=your.email@domain.com   # TODO: Replace with your email

# TODO: Set your experiment type (test/train) or add custom types
EXPERIMENT_TYPE=${1:-train}

# Validate the argument - TODO: Modify validation for your experiment types
...
# Load modules - TODO: Adjust modules for your system
...
# PyTorch/ROCm environment variables - TODO: Adjust for your GPU type
export PYTORCH_HIP_ALLOC_CONF=garbage_collection_threshold:0.8,max_split_size_mb:512
export HIP_FORCE_DEV_KERNARG=1
export NCCL_DEBUG=INFO
export TORCH_NCCL_BLOCKING_WAIT=0

# Configure MIOpen cache - TODO: Adjust cache settings if needed
...
# WandB configuration - TODO: Replace with your API key and adjust paths
export WANDB_MODE=offline
export WANDB_DIR="$HOME/wandb_offline_logs"
export WANDB_API_KEY="your_wandb_api_key_here"  # TODO: Replace with your key
mkdir -p $HOME/wandb_offline_logs

# Accelerate configuration via environment variables - TODO: Adjust as needed
export ACCELERATE_MIXED_PRECISION="bf16"
export ACCELERATE_USE_CPU="false"
# TODO: Specify which accelerate config file to use
...
# TODO: Replace this section with your experiment launch command
# Use srun to launch your training script
...
# TODO: Replace with your experiment command
# Example using the existing hydra experiment runner:
...
# python -m your_module.train --args
"
